...
@include('laboratorio._cliente')
@include('laboratorio._equipo')
<div class="card my-2">
    ...
    <div class="card-body pt-2">
        <div class="row">
            <div class="col-sm-4 col-lg-4">
                ...
                <input type="text" class="form-control" name="product" placeholder="Producto" value="{{ old("", $service->product->name ) }}">
            </div>
            <div class="col-sm-3 col-lg-3">
                <label for="staticEmail" class="col-form-label">No. de serie</label>
                <input type="text" class="form-control" placeholder="No. de serial" name="no_serial" value="{{ old("no_serial", $service->serie ) }}">
            </div>
            <div class="col-sm-3 col-lg-3">
            ...
            <div class="form-check form-switch col-sm-2 col-lg-2">
                ...
                <input class="form-check-input" name="cumple" type="checkbox" id="flexSwitchCheckChecked">
            </div>
