<html>
    ...
    <body>
        ...
        <footer>
            <table class="table table-sm">
                <tr style="padding:1px 0px;">
                    <td style="border:0px;padding:0px;text-align:left;">Toposervis s de rl de cv</td>
                    <td style="border:0px;padding:0px;text-align:right;">Certificado <strong>No {{$report->folio}}</strong></td>
                </tr>
                <tr style="padding:1px 0px;">
                    <td style="border:0px;padding:0px;text-align:left;">www.toposervi.com</td>
                    <td style="border:0px;padding:0px;text-align:right;">Queda prohibida la reproducción</td>
                </tr>
                <tr style="padding:1px 0px;">
                    <td style="border:0px;padding:0px;text-align:left;">99999999</td>
                    <td style="border:0px;padding:0px;text-align:right;">total o parcial</td>
                </tr>
            </table>
        </footer>
        ...
        <main>
            <table class="table table-striped table-sm">
                ...
                <tfoot>
                    <tr>
                        ...
                        ?>
                        <td>Σrj2= <span id="sumatoriarj2">{{ $erj2 }}</span></td>
            ...
            <table class="table table-sm text-center" style="border:0px;margin:2cm 0cm;">
                <tr>
                    <td style="border:0px;">
                        <img src="https://certificaciones.toposervis.com.mx/assets/images/Toposervis-Logo.png" width="150">
                    </td>
                    <td style="border:0px;">
                        <img src="https://certificaciones.toposervis.com.mx/assets/images/Toposervis-Logo.png" width="150">
                    </td>
            ...
            <table class="table table-sm text-center" style="border:0px;margin-top:1cm;">
                <tr>
                    <td colspan="2" style="text-align:center;border:0px;">
                        <img src="{{URL::to('/')}}{{ Storage::url('qrcodes/CT-0001.png') }}" width="180"><br>
