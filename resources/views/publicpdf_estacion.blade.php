...
<body>
    ...
    <footer>
        <table class="table table-sm">
            <tr style="padding:1px 0px;">
                <td style="border:0px;padding:0px;text-align:left;">Toposervis S.A de C.V <br>C. 42 #264 por 41A y 41
                    <br>Col. Francisco de Montejo III,<br> Mérida, Yucatán, México</td>
    ...
    <main>
        <table>
            <tr>
                ...
                <td class="text-center">
                    <p style="font-size:22px;font-weight:bold;line-height:28px;">TOPOSERVIS S DE RL DE CV CONSTANCIA DE
                        CALIBRACIÓN</p>
        ...
        <table class="table table-sm" style="border:0px;">
            ...
            <tr>
                <td style="border:0px;">Nombre</td>
                <td style="border:0px;">{{ $customer['name'] ?? "" }}</td>
            </tr>
            <tr>
                <td style="border:0px;">Dirección</td>
                <td style="border:0px;">{{ $customer['address'] ?? "" }}</td>
            </tr>
            <tr>
                <td style="border:0px;">Correo</td>
                <td style="border:0px;">{{ $customer['email'] ?? "" }}</td>
            </tr>
            <tr>
                <td style="border:0px;">Teléfono</td>
                <td style="border:0px;">{{$customer['phone' ?? "" ]}}</td>
            </tr>
        </table>
        <table class="table table-sm" style="border:0px;">
            <tr class="bg-topo">
            ...
            <tr>
                <td style="border:0px;">Equipo</td>
                <td style="border:0px;">{{$equipment['equipment'] ?? "" }}</td>
            </tr>
            <tr>
                <td style="border:0px;">Marca</td>
                <td style="border:0px;">{{$equipment['brand'] ?? "" }}</td>
            </tr>
            <tr>
                <td style="border:0px;">Modelo</td>
                <td style="border:0px;">{{$equipment['model'] ?? "" }}</td>
            </tr>
            <tr>
                <td style="border:0px;">No. serie</td>
                <td style="border:0px;">{{$equipment['no_serie'] ?? "" }}</td>
            </tr>
        </table>
        <table class="table table-sm" style="border:0px;">
                <tr class="bg-topo">
    ...
    <main>
        ...
        <table class="table table-sm" style="border:0px;">
            ...
            <tr>
                <td style="border:0px;">Obvservador: {{ $prisma->observer}}</td>
    ...
    <main>
        ...
        <main>
            <table class="table table-sm" style="border:0px;">
                ...
                <tr>
                    <td style="border:0px;">Obvservador: {{ $angulos_h->observer}}</td>
        ...
        <main>
            ...
            <table class="table table-sm" style="border:0px;">
                ...
                <tr>
                    <td style="border:0px;">Obvservador: {{ $angulos_v->observer}}</td>
