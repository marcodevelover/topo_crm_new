...
Route::get('cdc-toposervis/{folio}','HomeController@pdf')->name('cdc-toposervis');

Route::post('buscar','ReportController@search')->name('buscar');
Route::post('lab-buscar','LaboratorioController@labbuscar')->name('lab-buscar');

// Route::post('certificaciones.buscar','ReportController@search')->name('certificaciones.buscar');

Route::get('certificado-nivel/{id}','ReportController@createcertificado');
...
Route::resource('/patrones','PatternController')
->parameters(['patrones'=>'pattern'])->names('patrones');
